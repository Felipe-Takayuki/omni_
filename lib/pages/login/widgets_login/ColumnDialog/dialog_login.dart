...
class dialogbase extends StatefulWidget {
  ...
  const dialogbase({super.key, required this.funcConfirm, required this.funcCancel ,required this.invisible1, required this.invisible2,required this.titlelabeltext2, required this.titlelabeltext1});
